...
let BGG_API = {
  ...
  fetchUsersOwnedCollection(user) {
    ...
    return this._getAjax().then(function(collectionObj) {
  ...
  checkUserName(name) {
    ...
    return this._getAjax().then(function(nameObj) {
  ...
  getGameInfoById(gameID) {
    ...
    return this._getAjax().then(function (thingObj) {
      // console.log(thingObj.items.item);
      const item = thingObj.items.item;
        return {
